...
* Make the element with both the `avatar` and `distorted` classes 200 pixels wide, then makeel value its height twice as big as its width (here you should hardcode in a pix).
